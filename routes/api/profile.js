...
router.put(
  ...
  async (req, res) => {
    ...
    //Create the object which is newExp that with the data that user will submit
    const newExp = {
      title,
      company,
      location,
...
//@rute Delete api/profile/education/:edu_id
...
//@rute Get api/profile/github/:username
...
router.get('/github/:username', async (req, res) => {
  try {
    const options = {
      uri: `http://api.github.com/users/${req.params.username}/repos?per_page=5&sort=created:asc&client_id=${process.env.GITHUB_CLIENTID}&client_secret=${process.env.GITHUB_CLIENTSECRET}`,
      method: 'GET',
